...
angular.module('esqueleto')
    .controller('uneteController', function ($scope, $routeParams, $route, $firebase, $firebaseObject, $firebaseArray) {
    'use strict';
    ...
    $scope.newP = function(){
        ...
        if (!$scope.uniqidid) {
            ...
            Email.send({
                ...
                Username : "ramon@comcomcom.io",
                Password : "E4E1C34F93285194B587050DE17C91A3D9AC",
                To : 'ramon@comcomcom.io',
                From : "robot@intheparkmanagement.com",
